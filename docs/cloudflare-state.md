...
Generated: 2026-07-05 15:49:14 +03:00

Repository root: C:/Users/USER/tobymusic-site

Detected project mode: worker-with-assets

Configured Worker/Project name: tobymusic-site
...
Output:
~~~text
cd473c713c555601779cc262bc84750bab3e0fb1
~~~
...
### Cloudflare Pages deployment lookup skipped
...
Output:
~~~text
This repository uses wrangler.jsonc main=worker/index.ts and assets, so tobymusic-site is handled as a Cloudflare Worker, not a Cloudflare Pages project.
~~~
...
≡ƒ¬╡  Logs were written to "C:\Users\USER\AppData\Roaming\xdg.config\.wrangler\logs\wrangler-2026-07-05_12-49-12_147.log"
~~~
